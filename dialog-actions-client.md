...
For information about how to call an external service, such as a {{site.data.keyword.openwhisk_short}} web action, see [Making a programmatic call from a dialog node](/docs/services/assistant-data?topic=assistant-data-dialog-webhooks).
