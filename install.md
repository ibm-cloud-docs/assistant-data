...
As of 30 August 2023, this documentation is no longer being updated. For the most up-to-date version, see [Installing {{site.data.keyword.assistant_classic_short}} for {{site.data.keyword.icp4dfull_notm}}](/docs/watson-assistant?topic=watson-assistant-install-data){: external}.{: external}
{: attention}
...
The installation process differs depending on the version that you are installing. The following table shows the available versions.
