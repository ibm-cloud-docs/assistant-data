...
Documentation about **{{site.data.keyword.assistant_classic_full}} for {{site.data.keyword.icp4dfull}}** has moved. For the most up-to-date version, see [Personalizing the dialog with context](/docs/watson-assistant?topic=watson-assistant-dialog-runtime-context){: external}.
{: attention}
...
{: caption="Name and value pair examples" caption-side="top"}
...
{: caption="Using a Sting method" caption-side="top"}
...
|----------|------------------------|
| email    | `<? @email.literal ?>` |
{: caption="Capturing a patten entity value" caption-side="top"}
...
{: caption="Using two variables to get a value from user input" caption-side="top"}
...
{: caption="Combining two variables into one" caption-side="top"}
...
|-----------|--------|
| var2      | var1   |
{: caption="Example context variable" caption-side="top"}
