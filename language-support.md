...
Documentation about **{{site.data.keyword.assistant_classic_full}} for {{site.data.keyword.icp4dfull}}** has moved. For the most up-to-date version, see [Supported languages](/docs/watson-assistant?topic=watson-assistant-admin-language-support#admin-language-support-codes){: external}.
{: attention}
...
| Language |[**Dialog skill**](/docs/assistant-data?topic=assistant-data-skill-dialog-add) | [**Search skill**](/docs/assistant-data?topic=assistant-data-skill-search-add) |
|:---:|:---:|:---:|
| **English (en)**                   | GA | GA |
| **Arabic (ar)**                    | GA | GA |
...
| Language | **[Content Catalog](/docs/assistant-data?topic=assistant-data-catalog)** | **[Irrelevance detection](/docs/assistant-data?topic=assistant-data-irrelevance-detection)** | **[Enhanced intent detection](/docs/assistant-data?topic=assistant-data-intent-detection)** |
|:---:|:---:|:---:|:---:|
| **English (en)**                   | GA | GA | GA |
...
| Language | **[Dictionary-based entity support](/docs/assistant-data?topic=assistant-data-entities#entities-create-dictionary-based)** | **[Fuzzy matching (*Misspelling*)](/docs/assistant-data?topic=assistant-data-entities#entities-fuzzy-matching)** | **[Fuzzy matching (*Stemming*, *Partial match*)](/docs/assistant-data?topic=assistant-data-entities#entities-fuzzy-matching)** | **[Autocorrection](/docs/assistant-data?topic=assistant-data-dialog-runtime-spell-check)** |
|:---:|:---:|:---:|:---:|:---:|
...
| Language | **[System entities](/docs/assistant-data?topic=assistant-data-system-entities)** | **[Legacy system entities](/docs/assistant-data?topic=assistant-data-legacy-system-entities)** |
|:---|:---:|:---:|
