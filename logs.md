...
Documentation about **{{site.data.keyword.assistant_classic_full}} for {{site.data.keyword.icp4dfull}}** has moved. For the most up-to-date version, see [Improving your dialog skill](/docs/watson-assistant?topic=watson-assistant-logs){: external}.
{: attention}
