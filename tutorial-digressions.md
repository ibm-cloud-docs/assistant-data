...
If you do not have a {{site.data.keyword.conversationshort}} instance, complete the **Before you begin** step from the [Getting Started tutorial](/docs/services/assistant-data?topic=assistant-data-getting-started#getting-started-prerequisites) to create one.
...
For help as you configure digressions for your own dialog, see [Digressions](/docs/services/assistant-data?topic=assistant-data-dialog-runtime#dialog-runtime-digressions).
