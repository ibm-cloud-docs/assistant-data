...
1.  If you have not started to create a dialog, follow the instructions in [Creating a dialog](/docs/services/assistant-data?topic=assistant-data-dialog-build) to create one.
...
Give it a try! Follow the step-by-step [tutorial](/docs/services/assistant-data?topic=assistant-data-tutorial-slots).
...
See [Expression language methods](/docs/services/assistant-data?topic=assistant-data-dialog-methods) for other reformatting ideas.
