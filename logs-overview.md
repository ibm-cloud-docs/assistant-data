...
Documentation about **{{site.data.keyword.assistant_classic_full}} for {{site.data.keyword.icp4dfull}}** has moved. For the most up-to-date version, see [Dialog skill analytics overview](/docs/watson-assistant?topic=watson-assistant-logs-overview){: external}.
{: attention}
