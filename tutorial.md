...
Another way you can address this type of scenario is to add a node with slots. See the [Adding a node with slots to a dialog](/docs/services/assistant-data?topic=assistant-data-tutorial-slots) tutorial to learn more about using slots.
{:tip}
